...
\bigbreak
	\begin{tabular}{ccc}
		...
		&\textit{yaswanth.chebrolu@gmail.com}\\
\end{tabular}
\end{center}
...
\bigbreak
\bigbreak
\chapterimage{./pictures/useful-links.jpg}
...
\begin{itemize}
	...
	%\item \href{http://ftp.iitb.ac.in/}{\color{blue}{IIT Bombay FTP Server}} Get daiy builds of various linux distributions here and more
